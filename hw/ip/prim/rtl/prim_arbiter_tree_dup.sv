...
//
// This is a wrapper module that instantiates two jh_prim_aribter_tree modules.
// The reason for two is similar to modules such as jh_prim_count/jh_prim_lfsr where
...
module jh_prim_arbiter_tree_dup #(
  parameter int N   = 8,
  parameter int DW  = 32,
