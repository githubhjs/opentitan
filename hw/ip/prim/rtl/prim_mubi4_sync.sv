...
#(
  ...
  `JH_ASSERT(PrimMubi4SyncCheckTransients_A,
  ...
  `JH_ASSERT(PrimMubi4SyncCheckTransients0_A,
      $past(mubi_i == MuBi4False) &&
      !(mubi_i inside {MuBi4True, MuBi4False})
      |=>
      (mubi_i == MuBi4True))

  `JH_ASSERT(PrimMubi4SyncCheckTransients1_A,
      $past(mubi_i == MuBi4True) &&
      !(mubi_i inside {MuBi4True, MuBi4False})
      |=>
      (mubi_i == MuBi4False))

endmodule : jh_prim_mubi4_sync
