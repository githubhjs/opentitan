...
#(
  ...
  `JH_ASSERT(PrimMubi8SyncCheckTransients_A,
  ...
  `JH_ASSERT(PrimMubi8SyncCheckTransients0_A,
      $past(mubi_i == MuBi8False) &&
      !(mubi_i inside {MuBi8True, MuBi8False})
      |=>
      (mubi_i == MuBi8True))

  `JH_ASSERT(PrimMubi8SyncCheckTransients1_A,
      $past(mubi_i == MuBi8True) &&
      !(mubi_i inside {MuBi8True, MuBi8False})
      |=>
      (mubi_i == MuBi8False))

endmodule : jh_prim_mubi8_sync
